...
var bing_spider_cluster_marker_1 = require("./bing-spider-cluster-marker");
var bing_marker_1 = require("./bing-marker");
/**
...
var BingClusterLayer = (function () {
     ...
     * @memberof BingClusterLayer
     */
    BingClusterLayer.prototype.AddListener = function (eventType, fn) {
     ...
     * @memberof BingClusterLayer
     */
    BingClusterLayer.prototype.AddEntity = function (entity) {
        if (entity instanceof marker_1.Marker || entity instanceof bing_marker_1.BingMarker) {
            if (entity.IsFirst) {
                this.StopClustering();
            }
        }
     ...
     * @memberof BingClusterLayer
     */
    BingClusterLayer.prototype.InitializeSpiderClusterSupport = function (options) {
        var _this = this;
     ...
     * @memberof BingClusterLayer
     */
    BingClusterLayer.prototype.Delete = function () {
        var _this = this;
        if (this._useSpiderCluster) {
     ...
     * @memberof BingClusterLayer
     */
    BingClusterLayer.prototype.GetMarkerFromBingMarker = function (pin) {
     ...
     * @memberof BingClusterLayer
     */
    BingClusterLayer.prototype.GetOptions = function () {
     ...
     * @memberof BingClusterLayer
     */
    BingClusterLayer.prototype.GetVisible = function () {
     ...
     * @memberof BingClusterLayer
     */
    BingClusterLayer.prototype.RemoveEntity = function (entity) {
        if (entity.NativePrimitve && entity.Location) {
            ...
            if (this._isClustering) {
                var p = this._layer.getPushpins();
                var i = p.findIndex(function (x) { return x === entity.NativePrimitve; });
                if (i > -1) {
                    p.splice(i, 1);
                    this._layer.setPushpins(p);
                }
     ...
     * @memberof BingClusterLayer
     */
    BingClusterLayer.prototype.SetEntities = function (entities) {
        var _this = this;
        var p = new Array();
        this._markers.splice(0);
     ...
     * @memberof BingClusterLayer
     */
    BingClusterLayer.prototype.SetOptions = function (options) {
     ...
     * @memberof BingClusterLayer
     */
    BingClusterLayer.prototype.SetVisible = function (visible) {
        var o = this._layer.getOptions();
        o.visible = visible;
        this._layer.setOptions(o);
    };
     ...
     * @memberof BingClusterLayer
     */
    BingClusterLayer.prototype.StartClustering = function () {
        if (this._isClustering) {
            return;
        }
        var p = new Array();
     ...
     * @memberof BingClusterLayer
     */
    BingClusterLayer.prototype.StopClustering = function () {
        if (!this._isClustering) {
            return;
        }
     ...
     * @memberof BingClusterLayer
     */
    BingClusterLayer.prototype.GetBasicPushpinOptions = function (pin) {
        return {
     ...
     * @memberof BingClusterLayer
     */
    BingClusterLayer.prototype.GetSpiderMarkerFromBingMarker = function (pin) {
        var i = this._spiderMarkers.findIndex(function (e) { return e.NativePrimitve === pin; });
        if (i > -1) {
            return this._spiderMarkers[i];
        }
        return null;
    };
    /**
     ...
     * @memberof BingClusterLayer
     */
    BingClusterLayer.prototype.HideSpiderCluster = function () {
        this._mapclicks = 0;
     ...
     * @memberof BingClusterLayer
     */
    BingClusterLayer.prototype.OnLayerClick = function (e) {
        if (e.primitive instanceof Microsoft.Maps.ClusterPushpin) {
            ...
            if (pin.metadata && pin.metadata.isClusterMarker) {
                ...
                if (this._spiderOptions.markerSelected) {
                    this._spiderOptions.markerSelected(p, new bing_marker_1.BingMarker(this._currentCluster));
                }
     ...
     * @memberof BingClusterLayer
     */
    BingClusterLayer.prototype.OnMapClick = function (e) {
     ...
     * @memberof BingClusterLayer
     */
    BingClusterLayer.prototype.OnMapViewChangeEnd = function (e) {
     ...
     * @memberof BingClusterLayer
     */
    BingClusterLayer.prototype.OnMapViewChangeStart = function (e) {
     ...
     * @param e - Mouse event.
     */
    BingClusterLayer.prototype.OnSpiderMouseOut = function (e) {
        var pin = e.primitive;
     ...
     * @param e - Mouse event.
     */
    BingClusterLayer.prototype.OnSpiderMouseOver = function (e) {
        var pin = e.primitive;
        if (pin instanceof Microsoft.Maps.Pushpin && pin.metadata && pin.metadata.isClusterMarker) {
            var m = this.GetSpiderMarkerFromBingMarker(pin);
     ...
     * @memberof BingClusterLayer
     */
    BingClusterLayer.prototype.SetSpiderOptions = function (options) {
        if (options) {
     ...
     * @memberof BingClusterLayer
     */
    BingClusterLayer.prototype.ShowSpiderCluster = function (cluster) {
        this.HideSpiderCluster();
        ...
        if (cluster && cluster.containedPushpins) {
            ...
            for (var i = 0, len = pins.length; i < len; i++) {
                ...
                var spiderMarker = new bing_spider_cluster_marker_1.BingSpiderClusterMarker(pin);
...
//# sourceMappingURL=bing-cluster-layer.js.map