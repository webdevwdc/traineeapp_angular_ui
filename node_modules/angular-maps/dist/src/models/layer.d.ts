...
export declare abstract class Layer {
     ...
     * @memberof Layer
     */
    abstract AddEntity(entity: Marker | InfoWindow | any): void;
    /**
     * Deletes the layer.
     *
     * @memberof Layer
    ...
    * @memberof Layer
    */
    abstract RemoveEntity(entity: Marker | InfoWindow | any): void;
    /**
    ...
    * @memberof Layer
    */
    abstract SetEntities(entities: Array<Marker> | Array<InfoWindow> | Array<any>): void;
    /**
