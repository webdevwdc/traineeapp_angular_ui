...
export declare abstract class ClusterService {
     ...
     */
    abstract AddLayer(layer: ClusterLayerDirective): void;
    /**
     ...
     * @memberof ClusterService
     */
    abstract GetNativeLayer(layer: ClusterLayerDirective): Promise<Layer>;
    /**
     * Deletes the layer
     *
     * @abstract
     ...
     * @memberof ClusterService
     */
    abstract DeleteLayer(layer: ClusterLayerDirective): Promise<void>;
    /**
     ...
     * @memberof ClusterService
     */
    abstract CreatePolyline(layer: number, options: IPolylineOptions): Promise<Polyline | Array<Polyline>>;
    /**
