...
var GooglePolygonService = (function () {
     ...
     * @memberof GooglePolygonService
     */
    GooglePolygonService.prototype.AddPolygon = function (polygon) {
        var o = {
            id: polygon.Id,
    ...
    /**
      ...
      * @memberof GooglePolygonService
      */
    GooglePolygonService.prototype.CreateEventObservable = function (eventName, polygon) {
        var _this = this;
    ...
    /**
      ...
      * @memberof GooglePolygonService
      */
    GooglePolygonService.prototype.DeletePolygon = function (polygon) {
        var _this = this;
     ...
     * @memberof GooglePolygonService
     */
    GooglePolygonService.prototype.GetCoordinatesFromClick = function (e) {
     ...
     * @memberof GooglePolygonService
     */
    GooglePolygonService.prototype.GetNativePolygon = function (polygon) {
     ...
     * @memberof GooglePolygonService
     */
    GooglePolygonService.prototype.SetOptions = function (polygon, options) {
     ...
     * @memberof GooglePolygonService
     */
    GooglePolygonService.prototype.UpdatePolygon = function (polygon) {
        var _this = this;
        var m = this._polygons.get(polygon);
        if (m == null) {
            return Promise.resolve();
...
//# sourceMappingURL=google-polygon.service.js.map