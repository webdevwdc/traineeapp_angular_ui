...
var ColorPickerDirective = (function () {
    function ColorPickerDirective(appRef, vcRef, el, injector, service, cfr, cdr) {
        this.appRef = appRef;
        this.vcRef = vcRef;
        this.el = el;
...
ColorPickerDirective = __decorate([
    ...
    __metadata("design:paramtypes", [core_1.ApplicationRef, core_1.ViewContainerRef, core_1.ElementRef, core_1.Injector, color_picker_service_1.ColorPickerService, core_1.ComponentFactoryResolver, core_1.ChangeDetectorRef])
